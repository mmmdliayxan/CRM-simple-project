package org.example.crmbackinterntask.jwt.impl;
...
public class JwtServiceImpl implements JwtService {
    ...
    public String issueToken(User user) {
        user = userRepository.findByUsername(user.getUsername()).orElseThrow(()-> new NoSuchElementException("User is not found"));
